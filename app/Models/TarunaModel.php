...
class TarunaModel extends Model
{
  ...
  {
    return $this->select('taruna.id as id, taruna.nama as nama, taruna.nomer_taruna as nomer_taruna, kota.id as kota_id, kota.nama as tempat_lahir, taruna.tanggal_lahir as tanggal_lahir, program_studi.id as program_studi_id,  program_studi.nama as program_studi, taruna.foto as foto')
