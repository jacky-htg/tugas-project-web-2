              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="item form-group">
                    ...
                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="is_actived">Is Actived <span class="required">*</span></label>
                      <div class="col-md-9 col-sm-9 ">
                        <div class="">
                          <input name="is_actived" type="checkbox" class="js-switch" <?= $user['is_actived']?"checked":""; ?> data-switchery="true" style="display: none;">
                        </div>
                      </div>
                    </div>
                    <div class="item form-group">
