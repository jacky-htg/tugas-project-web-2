                ...
                <div class="x_panel">
                  ...
                  <div class="item form-group">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 ">
                        <input type="text" id="nip" name="nip" required="required" class="form-control " value="<?= set_value('nip') ?>" >
                      </div>
                    </div>
                    <div class="item form-group">
                      <label class="col-form-label col-md-3 col-sm-3 label-align" for="golongan">Golongan <span class="required">*</span></label>
                      <div class="col-md-6 col-sm-6 ">
                        <input type="text" id="golongan" name="golongan" required="required" class="form-control " value="<?= set_value('golongan') ?>" >
                      </div>
                    </div>
                    <div class="item form-group">
                      <label class="col-form-label col-md-3 col-sm-3 label-align" for="jabatan">Jabatan <span class="required">*</span></label>
                      <div class="col-md-6 col-sm-6 ">
                        <input type="text" id="jabatan" name="jabatan" required="required" class="form-control " value="<?= set_value('jabatan') ?>" >
                      </div>
                    </div>
