                ...
                <div class="x_panel">
                  ...
                  <?= form_open_multipart("taruna/{$taruna['id']}/update"); ?>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 ">
                        <input type="text" id="tempat_lahir" name="tempat_lahir" required="required" class="form-control " value="<?= set_value('tempat_lahir')?set_value('tempat_lahir'):$taruna['tempat_lahir'] ?>" >
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 ">
                        <input type="text" id="program_studi" name="program_studi" required="required" class="form-control " value="<?= set_value('program_studi')?set_value('program_studi'):$taruna['program_studi'] ?>" >
                      </div>
                    </div>
