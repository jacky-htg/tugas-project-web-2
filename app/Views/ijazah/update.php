                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                <select id="nilai_kkw" class="form-control" name="nilai_kkw">
                                    <option value="A" <?php if (set_value('nilai_kkw')){ echo set_value('nilai_kkw')==='A'?'selected':'';} else { echo $ijazah['nilai_kkw'] === 'A'?'selected':'';};?> >A</option>
                                    <option value="AB" <?php if (set_value('nilai_kkw')){ echo set_value('nilai_kkw')==='AB'?'selected':'';} else { echo $ijazah['nilai_kkw'] === 'AB'?'selected':'';};?> >AB</option>
                                    <option value="B" <?php if (set_value('nilai_kkw')){ echo set_value('nilai_kkw')==='B'?'selected':'';} else { echo $ijazah['nilai_kkw'] === 'B'?'selected':'';};?> >B</option>
                                    <option value="C" <?php if (set_value('nilai_kkw')){ echo set_value('nilai_kkw')==='C'?'selected':'';} else { echo $ijazah['nilai_kkw'] === 'C'?'selected':'';};?> >C</option>
                                    <option value="D" <?php if (set_value('nilai_kkw')){ echo set_value('nilai_kkw')==='D'?'selected':'';} else { echo $ijazah['nilai_kkw'] === 'D'?'selected':'';};?> >D</option>
                                    <option value="E" <?php if (set_value('nilai_kkw')){ echo set_value('nilai_kkw')==='E'?'selected':'';} else { echo $ijazah['nilai_kkw'] === 'E'?'selected':'';};?> >E</option>
                                </select>
                            </div>
                        </div>
